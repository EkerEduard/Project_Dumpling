...
public class LevelGenerator : MonoBehaviour
{
    ...
    private void GenerateNextLevelPart()
    {
        ...
        LevelPart levelPartScripts = newPart.GetComponent<LevelPart>();

        levelPartScripts.SnapAndAlignPartTo(nextSnapPoint);

        if (levelPartScripts.IntersectionDetected())
        {
            Debug.LogWarning("Intersection between level parts!");
        }

        nextSnapPoint = levelPartScripts.GetExitPoint();
    }
